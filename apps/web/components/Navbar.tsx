...
import { LayoutDashboard, Video, GitBranch, FolderGit2, BarChart3, Cpu, Github } from 'lucide-react';
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '28px' }}>
        ...
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
          ...
          <div>
            <h1 style={{ fontSize: '1.15rem', fontWeight: 800, color: '#0f172a', margin: 0, lineHeight: 1.2 }}>Aftercode</h1>
